...
const directions = [
  ...
  "Prishtine (Te Ismeti)-Mitrovice",
  "Prishtine-Fushe Kosove",
  "Prishtine-Gjergj Balsha",
  "Mitrovicë-Lekë Matranga",
  "Prishtine-Obiliq (Mitrovice)",
  "Prishtine-Obiliq",
  "Prishtine (Bast Trade)-Mitrovice",
  "Prishtine (Mitrovice)-Obiliq",
  "Prishtine-Autostrada Ibrahim Rugova",
  "Prishtine (Gazimestan)-Mitrovice",
  "Prishtine (Millosheve)-Mitrovice",
  "Obiliq-Podujeve",
  "Podujevë-Obiliq-2",
