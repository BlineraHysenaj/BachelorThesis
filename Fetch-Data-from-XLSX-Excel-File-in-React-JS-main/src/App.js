...
const directions = [
  "Prishtine (Ambasada Amerikane)-Mitrovicë",
  "Prishtine (Te Ismeti)-Mitrovicë",
  "Prishtine-Fushe Kosove",
  "Prishtine-Gjergj Balsha",
  "Mitrovicë-Lekë Matranga",
  "Prishtine-Obiliq (Mitrovicë)",
  "Prishtine-Obiliq",
  "Prishtine (Bast Trade)-Mitrovicë",
  "Prishtine (Mitrovicë)-Obiliq",
  "Prishtine-Autostrada Ibrahim Rugova",
  "Prishtine (Gazimestan)-Mitrovicë",
  "Prishtine (Millosheve)-Mitrovicë",
  "Obiliq-Podujeve",
  "Podujevë-Obiliq-2",
  "Prishtine-Obliliq(Tyrbe)",
  "Kosova C-Obiliq",
  "QKUK-Qender",
  "Prishtine-Graqanice",
  "Prishtine-Gjilan",
  ...
  "Rrethrrotullim (Stacioni i Autobuseve)-Qender (Prishtine)",
  "Prishtina (M9)-F.Kosovë",
  "Rruga Nënë Tereza-F.Kosovë",
  "Rruga Nënë Tereza-Rrethrrotullim (F.Kosovë)",
  "Rrethrrotullim (F.Kosovë)-Stacioni i Trenit (F.Kosovë)",
...
const cities = [
  ...
  "Obiliq (Mitrovicë)",
  "Obiliq",
  "Prishtine (Bast Trade)",
  "Prishtine (Mitrovicë)",
  "Autostrada Ibrahim Rugova",
  "Prishtine (Gazimestan)",
  "Prishtine (Millosheve)",
  "Obiliq-Podujeve",
  "Podujeve",
  "Obiliq-2",
  "Obliliq(Tyrbe)",
